...
typedef struct {
    GtkWidget *final_window;
    GtkWidget  *final_question;
    GtkWidget *hint_text;
    GtkWidget *your_text_answer;
    GtkWidget *str1;
    GtkWidget *str2;
    GtkWidget *str3;
    GtkWidget *button_submit_char;
    GtkWidget *time_down;
    GtkWidget *button_submit_last_answer;
} FinalContainer;
typedef struct {
    GtkWidget *winner_back_home;
    GtkWidget *winner_window;
}WinnerContainer;

typedef struct {
    GtkWidget *loser_back_home;
    GtkWidget *loser_window;
}LoserContainer;

typedef struct{
    WinnerContainer winnerContainer;
    LoserContainer  loserContainer;
